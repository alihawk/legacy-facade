    ...
    <div className="min-h-screen relative">
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* REST API Card */}
          <Card
            className="group bg-slate-900/90 backdrop-blur-sm border-green-500/30 shadow-2xl hover:border-green-500/60 transition-all duration-500 cursor-pointer hover:shadow-green-500/20 hover:shadow-2xl hover:-translate-y-2"
            ...
            <CardContent className="p-8 h-full flex flex-col">
              <div className="flex flex-col items-center text-center flex-grow">
                ...
                <div className="relative mb-6">
                  ...
                  <div className="relative p-5 bg-gradient-to-br from-green-600/30 to-green-500/10 rounded-2xl border border-green-500/30 group-hover:border-green-500/50 transition-colors">
              ...
              <Button className="w-full text-white necro-button group-hover:shadow-lg group-hover:shadow-green-500/30 transition-all mt-auto">
        ...
        <div className="mt-16 text-center">
          <p className="text-gray-500 text-sm">
            Built for <span className="text-green-400 font-semibold">Kiroween 2024</span> • Powered by{" "}
