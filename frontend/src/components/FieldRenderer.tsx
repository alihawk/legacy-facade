...
export function FieldRenderer({ value, type, mode, onChange, name, isSpooky = false }: FieldRendererProps) {
...
function renderFormInput(type: string, value: any, onChange?: (v: any) => void, name?: string, isSpooky = false) {
